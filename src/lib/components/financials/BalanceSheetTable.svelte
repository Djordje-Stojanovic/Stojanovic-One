    ...
    <table class="w-full text-sm text-[#F9FAFB]">
        <thead>
            <tr class="border-b border-[#374151]">
                <th class="px-4 py-2 text-left font-medium sticky left-0 bg-[#1F2937] z-20">Balance Sheet</th>
        ...
        <tbody>
            ...
            <tr class="border-t border-[#374151] bg-[#374151]">
                <td class="px-4 py-2 font-medium sticky left-0 bg-[#374151] z-20" colspan="100">Current Assets</td>
            </tr>

            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Cash & Cash Equivalents</td>
                {#each sortedStatements as statement}
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Short Term Investments</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Net Receivables</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Inventory</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300 font-medium">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Total Current Assets</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <!-- Non-Current Assets -->
            <tr class="border-t border-[#374151] bg-[#374151]">
                <td class="px-4 py-2 font-medium sticky left-0 bg-[#374151] z-20" colspan="100">Non-Current Assets</td>
            </tr>

            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Property, Plant & Equipment</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Goodwill & Intangibles</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
                        {formatNumber(statement.goodwill_and_intangible_assets || 0, numberFormat).formatted}
                        <span class="text-gray-400 text-xs ml-1">
                            ({calculatePercentage(statement.goodwill_and_intangible_assets, statement.total_assets)})
                        </span>
                    </td>
                {/each}
            </tr>
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Long Term Investments</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300 font-medium">
                <td class="px-4 py-2 sticky left-0 bg-[#1F2937] z-20">Total Assets</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <!-- Liabilities Section -->
            <tr class="border-t border-[#374151] bg-[#374151]">
                <td class="px-4 py-2 font-medium sticky left-0 bg-[#374151] z-20" colspan="100">Current Liabilities</td>
            </tr>

            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Accounts Payable</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Short Term Debt</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300 font-medium">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Total Current Liabilities</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="border-t border-[#374151] bg-[#374151]">
                <td class="px-4 py-2 font-medium sticky left-0 bg-[#374151] z-20" colspan="100">Non-Current Liabilities</td>
            </tr>

            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Long Term Debt</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300 font-medium">
                <td class="px-4 py-2 sticky left-0 bg-[#1F2937] z-20">Total Liabilities</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="border-t border-[#374151] bg-[#374151]">
                <td class="px-4 py-2 font-medium sticky left-0 bg-[#374151] z-20" colspan="100">Shareholders' Equity</td>
            </tr>

            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Common Stock</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300">
                <td class="px-4 py-2 pl-8 sticky left-0 bg-[#1F2937] z-20">Retained Earnings</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
            ...
            <tr class="hover:bg-[#374151] transition-colors duration-300 font-medium">
                <td class="px-4 py-2 sticky left-0 bg-[#1F2937] z-20">Total Equity</td>
                {#each sortedStatements as statement}
                    <td class="px-4 py-2 text-right">
