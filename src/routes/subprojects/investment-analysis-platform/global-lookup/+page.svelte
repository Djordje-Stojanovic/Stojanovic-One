...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
  <div class="container mx-auto px-4 py-8">
    <h1 class="mb-6 text-3xl font-bold text-gray-800 dark:text-gray-100">Global Stock Lookup</h1>
    <div class="mb-4">
      <input
        type="text"
        placeholder="Search stocks..."
        bind:value={searchQuery}
        class="w-full rounded-md border border-gray-300 bg-white px-4 py-2 text-gray-700 focus:border-primary-500 focus:outline-none focus:ring-primary-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
      />
    </div>
    {#if loading}
    ...
    {:else}
      <div class="overflow-x-auto">
        <table class="w-full min-w-max text-left text-gray-700 dark:text-gray-200">
          <thead>
            <tr class="bg-gray-200 text-gray-700 uppercase text-sm leading-normal dark:bg-gray-700 dark:text-gray-200">
          ...
          <tbody class="text-sm font-light text-gray-700 dark:text-gray-200">
